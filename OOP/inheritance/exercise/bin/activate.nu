...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '\\wsl$\Ubuntu\home\dani\Projects\SoftUni\OOP\inheritance\exercise'
    let bin = 'bin'
    let path_sep = ';'
...
alias deactivate = source '\\wsl$\Ubuntu\home\dani\Projects\SoftUni\OOP\inheritance\exercise\bin\deactivate.nu'
