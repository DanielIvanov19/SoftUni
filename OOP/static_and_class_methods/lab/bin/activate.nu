...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '\\wsl$\Ubuntu\home\dani\Projects\SoftUni\OOP\static_and_class_methods\lab'
    let bin = 'bin'
    let path_sep = ';'
...
alias deactivate = source '\\wsl$\Ubuntu\home\dani\Projects\SoftUni\OOP\static_and_class_methods\lab\bin\deactivate.nu'
