...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '\\wsl$\Ubuntu\home\dani\Projects\SoftUni\advanced\exam'
    let bin = 'bin'
    let path_sep = ';'
...
alias deactivate = source '\\wsl$\Ubuntu\home\dani\Projects\SoftUni\advanced\exam\bin\deactivate.nu'
